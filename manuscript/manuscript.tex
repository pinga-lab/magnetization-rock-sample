...
Finally, \citet{fong2005} used a custom-designed low-transition-temperature 
...
(\textbf{Note to reviewers: the online repository will be made public upon
publication}).
...
where the sample standard deviation $\sigma \approx 60$~$\mu$T.
