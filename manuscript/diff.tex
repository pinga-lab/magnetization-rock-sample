...
%DIF DEL manuscript_R1.tex   Mon Jul 25 14:01:22 2016
%DIF ADD manuscript.tex      Mon Jul 25 15:33:38 2016
...
%\documentclass[twocolumn,gc]{agutex}
...
Finally, \citet{fong2005} \DIFdelbegin \DIFdel{presented a low-transition-temperature 
superconducting quantum interference device (low T$_{c}$ SQUID ) sensor
which is also considered planar and has an 
active area with
diameter of $80$}\DIFdelend \DIFaddbegin \DIFadd{used a bare SQUID design with an 
active diameter of $120$}\DIFaddend ~$\mu$m. \DIFdelbegin \DIFdel{This is currently one of the most powerful magnetic sensors}\DIFdelend \DIFaddbegin \DIFadd{In this case, the sensor 
is also considered planar}\DIFaddend .
...
%DIFDELCMD < 1/Q &\:, \quad (i - 1)Q \le j \le iQ \\
%DIFDELCMD < 0 &\:, \quad \text{otherwise}
%DIFDELCMD < \end{split}
%DIFDELCMD < \end{cases}
%DIFDELCMD < %%%
...
.
%DIF > \citep{perez2007}.
}\DIFaddend The notebook files combine the source code,
...
\url{https://github.com/pinga-lab/magnetization-rock-sample}\DIFdelbegin \DIFdel{(}\textbf{\DIFdel{Note to reviewers: the online repository will be made public upon
publication}}%DIFAUXCMD
\DIFdel{).
An archived version of this repository is also available at
}%DIFDELCMD < \url{http://dx.doi.org/...}
%DIFDELCMD < %%%
\DIFdel{(}\textbf{\DIFdel{Note to reviewers: the archived version will be uploaded upon
publication}}%DIFAUXCMD
\DIFdel{).
...
deviation equal to \DIFdelbegin \DIFdel{$30,000$}\DIFdelend \DIFaddbegin \DIFadd{$30$}\DIFaddend ~$\mu$T. These data simulate
...
where the sample standard deviation \DIFdelbegin \DIFdel{$\sigma \approx 60$}\DIFdelend \DIFaddbegin \DIFadd{$\sigma \approx 47$}\DIFaddend ~$\mu$T.
...
\citet{oda2011} }%DIFAUXCMD
proposed a new method for determining absolute 
...
}\DIFaddend The method proposed by \citet{oda2011} uses SQUID microscopy 
\DIFaddbegin \DIFadd{on thin sections }\DIFaddend to identify the boundaries of fine magnetic stripes 
...
\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citet{oda2011} }%DIFAUXCMD
applied their method }\DIFdelend \DIFaddbegin 

\DIFadd{\mbox{%DIFAUXCMD
\citet{oda2011} }%DIFAUXCMD
also used SQUID magnetometer measurements
}\DIFaddend to analyse a \DIFdelbegin \DIFdel{block of }\DIFdelend \DIFaddbegin \DIFadd{columnar block of their }\DIFaddend ferro-manganese crust \DIFdelbegin \DIFdel{obtained 
from a seamount in the Northwest Pacific Ocean}\DIFdelend \DIFaddbegin \DIFadd{sample}\DIFaddend .
They have cut and sliced \DIFdelbegin \DIFdel{a }\DIFdelend \DIFaddbegin \DIFadd{the }\DIFaddend columnar block parallel to the growth 
lamination at $1.5$~mm intervals using a $0.3$-mm-thick diamond-wire 
saw. After that, \DIFaddbegin \DIFadd{they estimated }\DIFaddend the magnetization of the slices \DIFdelbegin \DIFdel{have been estimated }\DIFdelend by 
...
determining the magnetization distribution along a simulated sample\DIFdelbegin \DIFdel{by }\DIFdelend \DIFaddbegin \DIFadd{.
This feasibility study consists in }\DIFaddend applying our method and 
directly inverting \DIFdelbegin \DIFdel{the }\DIFdelend \DIFaddbegin \DIFadd{simulated }\DIFaddend high-resolution measurements of 
...
their bottom.
\DIFdelbegin \DIFdel{The }\DIFdelend \DIFaddbegin \DIFadd{Figures \ref{fig:real-sample}b and c represent the magnetite 
...
in white. 
The }\DIFaddend magnetic induction produced by these low-concentration zones
...
\DIFdelbegin \DIFdel{of }\DIFdelend \DIFaddbegin \DIFadd{to }\DIFaddend traditional paleomagnetic techniques aiming at providing a 
...
\DIFaddbegin \DIFadd{A further study need to be carried out in order to evaluate
...
(\DIFdelbegin \DIFdel{http://www.fatiando.org/index.html}\DIFdelend \DIFaddbegin \url{http://www.fatiando.org}\DIFaddend ).
...
\DIFdelbegin %DIFDELCMD < \bibliography{bib-file-R1}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \bibliography{bib-file}
\DIFaddend %
...
%
%\bibitem[{\textit{Blackett}(1952)}]{blackett1952}
...
%  \textit{245}(897), 309--370, \doi{10.1098/rsta.1952.0024}.
%
...
%
%\bibitem[{\textit{Dodson et~al.}(1974)\textit{Dodson, Fuller, and
%  Pilant}}]{dodson1974}
...
%  \textit{1}(4), 185--188, \doi{10.1029/GL001i004p00185}.
%
...
%
%\bibitem[{\textit{Goree and Fuller}(1976)}]{goree-fuller1976}
...
%  Geophysics}, \textit{14}(4), 591--608, \doi{10.1029/RG014i004p00591}.
%
...
%
%\bibitem[{\textit{Hunter}(2007)}]{hunter2007}
...
%  Geosystems}, \textit{11}(7), \doi{10.1029/2009GC002991}.
%
...
%
%\bibitem[{\textit{Kirschvink et~al.}(2008)\textit{Kirschvink, Kopp, Raub,
...
%  Geophysics, Geosystems}, \textit{9}(5), \doi{10.1029/2007GC001856}.
%
...
%  -- 89, \doi{10.1016/j.palaeo.2014.10.037}.
%
...
%
%\bibitem[{\textit{Nagata}(1961)}]{nagata1961}
...
%  311--326, \doi{10.1007/s001900000116}.
%
%\bibitem[{\textit{Oda and Xuan}(2014)}]{oda-xuan2014}
...
%  (Melville, NY, U. S.)}, \textit{65}(1), 361--372, \doi{10.1063/1.342549}.
%
...
%
%\bibitem[{\textit{Turner et~al.}(2015)\textit{Turner, Rasson, and
%  Reeves}}]{turner2015}
...
%  \doi{10.1016/B978-0-444-53802-4.00098-1}.
%
...
%
%\bibitem[{\textit{Uieda et~al.}(2013)\textit{Uieda, Oliveira~Jr., and
%  Barbosa}}]{uieda2013}
...
%
%\bibitem[{\textit{Walt et~al.}(2011)\textit{Walt, Colbert, and
%  Varoquaux}}]{walt2011}
...
%  Engineering}, \textit{13}(2), 22--30, \doi{10.1109/MCSE.2011.37}.
%
...
%
 ...
 planes shown in (a)\DIFaddbeginFL \DIFaddFL{. The vertical gradient fill (shown in grey)
 ...
 at the bottom of the prisms are represented in dark grey}\DIFaddendFL .
...
\begin{table}
\caption{Approximated IRM orientation within the prisms forming 
...
\hline
\end{tabular}
\tablenotetext{a}{IRM inclination ($I$) and declination ($D$) 
